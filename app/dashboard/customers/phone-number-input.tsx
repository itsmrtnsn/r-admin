...
export default function PhoneNumberInput({
  ...
  return (
    <div className='space-y-2' dir='ltr'>
      <Label htmlFor='input-46' className='font-normal'>
        Numéro de téléphone
      </Label>
      <RPNInput.default
...
const PhoneInput = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, ...props }, ref) => {
    return (
      <Input
        className={`-ml-px h-10 shadow-none rounded-l-none focus-visible:z-10 ${className}`}
        ref={ref}
        {...props}
      />
    );
