    ...
    <Card className='overflow-hidden border-[0.1px] border-slate-300 shadow-none transition-all duration-300 hover:shadow-md'>
      <CardContent className='p-4'>
        <div className='flex flex-col h-full'>
          <h2 className='text-sm font-bold mb-2 text-slate-800 line-clamp-1'>
            {product.name}
          </h2>
          ...
          <div className='flex justify-between items-center mt-auto'>
            ...
            <Button
              ...
              className={cn(
                'rounded-full w-10 h-10 p-0 bg-primary hover:bg-primary/80 text-white transition-all duration-300 ease-in-out transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 bg-gradient-to-r from-[#1488CC] to-[#2B32B2]'
              )}
